...
public class HighlightSpeciesSubTreeEvent extends HighlightSubTreeEvent<HighlightSpeciesSubTreeEventHandler>
{

	public static final GwtEvent.Type<HighlightSpeciesSubTreeEventHandler> TYPE = new GwtEvent.Type<HighlightSpeciesSubTreeEventHandler>();
