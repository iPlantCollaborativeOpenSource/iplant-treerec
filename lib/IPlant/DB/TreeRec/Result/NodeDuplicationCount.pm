package IPlant::DB::TreeRec::Result::NodeDuplicationCount;
...
WHERE host_child_node_id = ? AND is_on_node IS TRUE
END_OF_DEFINITION
...
IPlant::DB::TreeRec::Result::GeneIdSearch – counts duplication events on a
node.
