package IPlant::DB::TreeRec::Result::GoSearch;
...
WHERE db.name = "GO" AND cvterm.name like ?
...
IPlant::DB::TreeRec::Result::GoSearch – searches for gene families by GO term.
