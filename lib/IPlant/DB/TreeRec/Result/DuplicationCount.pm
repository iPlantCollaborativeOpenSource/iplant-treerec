package IPlant::DB::TreeRec::Result::DuplicationCount;
...
SELECT COUNT(*) AS duplication_count
...
IPlant::DB::TreeRec::Result::DuplicationCount – counts the number of
duplication events in the gene family with the given identifier.

=head1 ACCESSORS

=head2 duplication_count
